class Carrinho:
    def __init__(self, id_carrinho: int, cliente: Cliente):
        ...
        self.itens: Dict[str, ItemCarrinho] = {}
    ...
    def remover_produto(self, sku: str, quantidade: int = 1):
        ...
        if quantidade >= item.quantidade:
            item.produto.repor_estoque(item.quantidade)
            del self.itens[sku]
        else:
            item.quantidade -= quantidade
            item.produto.repor_estoque(quantidade)
